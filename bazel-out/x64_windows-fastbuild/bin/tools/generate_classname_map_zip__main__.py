...
_STAGE2_BOOTSTRAP = "_main/tools/_generate_classname_map_stage2_bootstrap.py"
...
# executable to use.
_PYTHON_BINARY_ACTUAL = "rules_python++python+python_3_11_x86_64-pc-windows-msvc/python.exe"
_WORKSPACE_NAME = "_main"
