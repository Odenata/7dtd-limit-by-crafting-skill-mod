...
MAIN_PATH = "_main/tools/generate_classname_to_crafting_skill_map.py"

# Module name to execute. Empty if MAIN is used.
MAIN_MODULE = ""

# runfiles-root relative path to the root of the venv
VENV_ROOT = "_main/tools/_generate_classname_map.venv"
...
# string otherwise.
VENV_SITE_PACKAGES = "lib/python3.11/site-packages"
